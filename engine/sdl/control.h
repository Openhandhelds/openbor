...
#elif PANDORA
	#define CONTROL_ESC                     SDL_SCANCODE_LCTRL /* PANDORA SELECT BUTTON */
	#define CONTROL_DEFAULT1_START          SDL_SCANCODE_LALT /* PANDORA START BUTTON */
	#define CONTROL_DEFAULT1_FIRE1          SDL_SCANCODE_HOME /* PANDORA BUTTON A */
	#define CONTROL_DEFAULT1_FIRE2          SDL_SCANCODE_PAGEDOWN /* PANDORA BUTTON X */
	#define CONTROL_DEFAULT1_FIRE3          SDL_SCANCODE_PAGEUP /* PANDORA BUTTON Y */
	#define CONTROL_DEFAULT1_FIRE4          SDL_SCANCODE_END /* PANDORA BUTTON B */
	#define CONTROL_DEFAULT1_FIRE5          SDL_SCANCODE_RSHIFT /* PANDORA LEFT SHOULDER */
	#define CONTROL_DEFAULT1_FIRE6          SDL_SCANCODE_RCTRL /* PANDORA RIGHT SHOULDER */
